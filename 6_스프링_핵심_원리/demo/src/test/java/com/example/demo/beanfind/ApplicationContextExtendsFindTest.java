...
public class ApplicationContextExtendsFindTest {
  ...
  void findBeanByParentTypeDuplicate() {
    // DiscountPolicy discountPolicy = ac.getAliases(DiscountPolicy.class);
  ...
  void findBeanByParentTypeBeanName() {
    ...
    assertThat(rateDiscountPolicy).isInstanceOf(DiscountPolicyRate.class)
  }
  ...
  void findBeanBySubType() {
    ...
    DiscountPolicyRate bean = ac.getBean(DiscountPolicyRate.class);
    assertThat(bean).isInstanceOf(DiscountPolicyRate.class);
  }
